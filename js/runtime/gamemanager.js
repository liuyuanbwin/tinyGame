...
export default class GameManager extends Sprite{
  ...
  addnum(ctx) {
    ...
    this.fillRoundHeader(ctx, START_X + this.leftpad(m), START_Y + this.toppad(n), GRID_CELL_WIDTH, GRID_CELL_WIDTH, GRID_CELL_RADIUS, num);
    ctx.beginPath();
    ctx.fillStyle = "#00f";
  ...
  move(m, n, num, M, N) {
    ...
    this.fillRoundHeader(this.ctx, START_X + this.leftpad(M), START_Y + this.toppad(N), GRID_CELL_WIDTH, GRID_CELL_WIDTH, GRID_CELL_RADIUS, num);
    if (num != 0) {
      this.text(M, N, num);
    }
    this.board[N][M] = num;
    //this.fillRoundRect(this.ctx, START_X + this.leftpad(m), START_Y + this.toppad(n), GRID_CELL_WIDTH, GRID_CELL_WIDTH, GRID_CELL_RADIUS, this.num_color(0));
     this.fillRoundHeader(this.ctx, START_X + this.leftpad(m), START_Y + this.toppad(n), GRID_CELL_WIDTH, GRID_CELL_WIDTH, GRID_CELL_RADIUS, 0);
    this.board[n][m] = 0;
  }
